...
/**
 * The code below was used as an attempt to "run" the program in order to find the solution.
 * However, in the end the solution can be found just by inspecting the program itself.
